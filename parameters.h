...
public:
  ...
  Field temperature;
  const Field pi_f;
  Field U, Up, J, Jp, U_d_s, U_d_c, U_p_s, U_p_c, U_pd_s, U_pd_c, U_pp_s,
      U_pp_c, U_d_coupl, U_p_coupl, U_pd_coupl, U_pp_coupl;
  Field U1, U2, U3;
  Field lambda_SO;
  bool k_SOC;
  ...
  parameters(ConcurrencyType &concurrency)
      : conc(concurrency), temperature(1.0),
        pi_f(3.141592653589793238462643383), U(1.1), Up(0.55), J(0.275),
        Jp(0.275), U_d_s(0.0), U_d_c(0.0), U_p_s(0.0), U_p_c(0.0), U_pd_s(0.0),
        U_pd_c(0.0), U_pp_s(0.0), U_pp_c(0.0), U_d_coupl(0.0), U_p_coupl(0.0),
  ...
  void readFromInputFile(const std::string &file) {
    ...
    if (Case == "BSCCObilayer_OD_1band_onlyA")
      kz2D *= pi_f;
  }
  ...
  void setParamBasedOnText(std::string &text, std::stringstream &str) {
    if (text.find("dimension") != std::string::npos)
      str >> (*this).dimension;
    else if (text.find("temperature") != std::string::npos)
      str >> (*this).temperature;
    else if (text.find("numberOfOrbitals") != std::string::npos)
      str >> (*this).nOrb;
    else if (text.find("chemicalPotential") != std::string::npos)
      str >> (*this).mu;
    else if (text.find("targetFilling") != std::string::npos)
      str >> (*this).nTarget;
      ...
      str >> (*this).hopping_t2;
    else if (text.find("fileID") != std::string::npos)
      str >> (*this).fileID;
    else if (text.find("complexHopping") != std::string::npos)
      ...
      str >> (*this).interpolateChi;
    else if (text.find("interpolateNqx") != std::string::npos)
      str >> (*this).interpolateNqx;
    else if (text.find("interpolateNqz") != std::string::npos)
      str >> (*this).interpolateNqz;
    else if (text.find("Coulomb1U") != std::string::npos)
      str >> (*this).U;
    else if (text.find("Coulomb2Up") != std::string::npos)
      str >> (*this).Up;
    else if (text.find("Coulomb3J") != std::string::npos)
      str >> (*this).J;
    else if (text.find("Coulomb4Jp") != std::string::npos)
      str >> (*this).Jp;
    else if (text.find("Coulomb5U_d") != std::string::npos)
      str >> (*this).U_d_c;
    else if (text.find("Coulomb6U_p") != std::string::npos)
      str >> (*this).U_p_c;
    else if (text.find("Coulomb7U_pd") != std::string::npos)
      str >> (*this).U_pd_c;
    else if (text.find("Coulomb8U_pp") != std::string::npos)
      str >> (*this).U_pp_c;
    else if (text.find("Coulomb9U_d") != std::string::npos)
      str >> (*this).U_d_s;
    else if (text.find("Coulomb10U_p") != std::string::npos)
      str >> (*this).U_p_s;
    else if (text.find("Coulomb11U_pd") != std::string::npos)
      str >> (*this).U_pd_s;
    else if (text.find("Coulomb12U_pp") != std::string::npos)
      str >> (*this).U_pp_s;
    else if (text.find("Coulomb13U_d_coupl") != std::string::npos)
      str >> (*this).U_d_coupl;
    else if (text.find("Coulomb14U_p_coupl") != std::string::npos)
      str >> (*this).U_p_coupl;
    else if (text.find("Coulomb15U_pd_coupl") != std::string::npos)
      str >> (*this).U_pd_coupl;
    else if (text.find("Coulomb16U_pp_coupl") != std::string::npos)
      str >> (*this).U_pp_coupl;
    else if (text.find("CoulombNiU") != std::string::npos)
      str >> (*this).U1;
    else if (text.find("CoulombNdU") != std::string::npos)
      str >> (*this).U2;
    else if (text.find("CoulombSU") != std::string::npos)
      str >> (*this).U3;
    else if (text.find("Lambda_SO") != std::string::npos)
      str >> (*this).lambda_SO;
    else if (text.find("k_SOC") != std::string::npos)
      str >> (*this).k_SOC;
    else if (text.find("sublattice") != std::string::npos)
      str >> (*this).sublattice;
    else if (text.find("deltaU0") != std::string::npos)
      str >> (*this).deltaU[0];
    else if (text.find("deltaU1") != std::string::npos)
      str >> (*this).deltaU[1];
    else if (text.find("deltaU2") != std::string::npos)
      str >> (*this).deltaU[2];
    else if (text.find("deltaU3") != std::string::npos)
      str >> (*this).deltaU[3];
      ...
      str >> (*this).chargeFactor;
    else if (text.find("spinFactor") != std::string::npos)
      str >> (*this).spinFactor;
    else if (text.find("nkBands") != std::string::npos)
      str >> (*this).nkBands;
    else if (text.find("nkIntegration") != std::string::npos)
      str >> (*this).nkInt;
    else if (text.find("nkzIntegration") != std::string::npos)
      str >> (*this).nkIntz;
    else if (text.find("kz2D") != std::string::npos)
      str >> (*this).kz2D;
    else if (text.find("a1x") != std::string::npos)
      str >> (*this).a1[0];
    else if (text.find("a1y") != std::string::npos)
      str >> (*this).a1[1];
    else if (text.find("a1z") != std::string::npos)
      str >> (*this).a1[2];
    else if (text.find("a2x") != std::string::npos)
      str >> (*this).a2[0];
    else if (text.find("a2y") != std::string::npos)
      str >> (*this).a2[1];
    else if (text.find("a2z") != std::string::npos)
      str >> (*this).a2[2];
    else if (text.find("a3x") != std::string::npos)
      str >> (*this).a3[0];
    else if (text.find("a3y") != std::string::npos)
      str >> (*this).a3[1];
    else if (text.find("a3z") != std::string::npos)
      str >> (*this).a3[2];
    else if (text.find("c1x") != std::string::npos)
      str >> (*this).chia1[0];
    else if (text.find("c1y") != std::string::npos)
      str >> (*this).chia1[1];
    else if (text.find("c1z") != std::string::npos)
      str >> (*this).chia1[2];
    else if (text.find("c2x") != std::string::npos)
      str >> (*this).chia2[0];
    else if (text.find("c2y") != std::string::npos)
      str >> (*this).chia2[1];
    else if (text.find("c2z") != std::string::npos)
      str >> (*this).chia2[2];
    else if (text.find("c3x") != std::string::npos)
      str >> (*this).chia3[0];
    else if (text.find("c3y") != std::string::npos)
      str >> (*this).chia3[1];
    else if (text.find("c3z") != std::string::npos)
      str >> (*this).chia3[2];
    else if (text.find("nqx") != std::string::npos)
      str >> (*this).nqx;
    else if (text.find("nqy") != std::string::npos)
      str >> (*this).nqy;
    else if (text.find("nqz") != std::string::npos)
      str >> (*this).nqz;
    else if (text.find("qxmin") != std::string::npos) {
      str >> (*this).qxmin;
      qxmin *= pi_f;
    } else if (text.find("qxmax") != std::string::npos) {
      str >> (*this).qxmax;
      qxmax *= pi_f;
    } else if (text.find("qymin") != std::string::npos) {
      str >> (*this).qymin;
      qymin *= pi_f;
    } else if (text.find("qymax") != std::string::npos) {
      str >> (*this).qymax;
      qymax *= pi_f;
    } else if (text.find("qzmin") != std::string::npos) {
      str >> (*this).qzmin;
      qzmin *= pi_f;
    } else if (text.find("qzmax") != std::string::npos) {
      str >> (*this).qzmax;
      qzmax *= pi_f;
    } else if (text.find("nw") != std::string::npos)
      str >> (*this).nw;
    else if (text.find("wmin") != std::string::npos)
      str >> (*this).wmin;
    else if (text.find("wmax") != std::string::npos)
      str >> (*this).wmax;
    else if (text.find("cacheBands") != std::string::npos)
      str >> (*this).cacheBands;
    else if (text.find("scState") != std::string::npos)
      str >> (*this).scState;
    else if (text.find("scGapfile") != std::string::npos)
      str >> (*this).scGapfile;
    else if (text.find("printGap") != std::string::npos)
      str >> (*this).printGap;
    else if (text.find("gAmpl") != std::string::npos)
      str >> (*this).gAmpl;
    else if (text.find("Delta0") != std::string::npos)
      str >> (*this).Delta0;
    else if (text.find("deltax") != std::string::npos)
      str >> (*this).deltax;
    else if (text.find("deltay") != std::string::npos)
      str >> (*this).deltay;
    else if (text.find("deltaz") != std::string::npos)
      str >> (*this).deltaz;
    else if (text.find("kTrafo") != std::string::npos)
      str >> (*this).kTrafo;
    else if (text.find("options") != std::string::npos)
      str >> (*this).options;
    else if (text.find("subOptions") != std::string::npos)
      str >> (*this).subOptions;
    else if (text.find("Case") != std::string::npos)
      str >> (*this).Case;
    else if (text.find("pairingSpinParity") != std::string::npos)
      str >> (*this).pairingSpinParity;
    else if (text.find("pairingFromSpin") != std::string::npos)
      str >> (*this).pairingFromSpin;
    else if (text.find("pairingFromCharge") != std::string::npos)
      str >> (*this).pairingFromCharge;
    else if (text.find("storeChi") != std::string::npos)
      str >> (*this).storeChi;
    else if (text.find("storeGammaOrb") != std::string::npos)
      str >> (*this).storeGammaOrb;
    else if (text.find("readChiForPairing") != std::string::npos)
      str >> (*this).readChi;
    else if (text.find("readChiForSus") != std::string::npos)
      str >> (*this).readChiForSus;
    else if (text.find("hybridization") != std::string::npos)
      str >> (*this).hyb;
    else if (text.find("spinOrbit") != std::string::npos)
      str >> (*this).LS;
    else if (text.find("hybStrength") != std::string::npos)
      str >> (*this).hybStrength;
    else if (text.find("hybBand1") != std::string::npos)
      str >> (*this).hybBand1;
    else if (text.find("hybBand2") != std::string::npos)
      str >> (*this).hybBand2;
    else if (text.find("nSitesPerUnitCell") != std::string::npos)
      str >> (*this).nSitesPerUnitCell;
    else if (text.find("nOrbAtom") != std::string::npos)
      str >> (*this).nOrbAtomStr;
    else if (text.find("nkPerSheet") != std::string::npos)
      str >> (*this).nkPerSheet;
    else if (text.find("FSnkz") != std::string::npos)
      str >> (*this).FSnkz;
    else if (text.find("Omega0") != std::string::npos)
      str >> (*this).Omega0;
    else if (text.find("signF") != std::string::npos)
      str >> (*this).signF;
    else if (text.find("damp") != std::string::npos)
      str >> (*this).damp;
    else if (text.find("calcOnlyDiagonal") != std::string::npos)
      str >> (*this).calcOnlyDiagonal;
    else if (text.find("writeFullChi0") != std::string::npos)
      str >> (*this).writeFullChi0;
    else if (text.find("fixEvecs") != std::string::npos)
      str >> (*this).fixEvecs;
    else if (text.find("calcLambdaZ") != std::string::npos)
      str >> (*this).calcLambdaZ;
    else if (text.find("oppositeSpinPairing") != std::string::npos)
      str >> (*this).oppositeSpinPairing;
    else if (text.find("explicitSpin") != std::string::npos)
      str >> (*this).explicitSpin;
    else if (text.find("couplingRatio") != std::string::npos)
      str >> (*this).couplingRatio;
    else if (text.find("zeemanField") != std::string::npos)
      str >> (*this).zeemanField;
    else if (text.find("qGridType") != std::string::npos)
      str >> (*this).qGridType;
    else if (text.find("momentumPath") != std::string::npos)
  ...
  void writeParameters(std::ostream &os) {
    ...
    os << "nOrbAtom = ";
    for (size_t i = 0; i < nOrbAtom.size(); i++)
      os << (*this).nOrbAtom[i] << " ";
    os << "\n";
  ...
  void broadcastParam() {
    ...
    if (conc.rank() == 0)
      std::cout << "Now broadcasting parameters! \n";
  ...
  // void fixParameters() {
  // if (explicitSpin) signF = -1; // if spin degree of freedom is explicitely
  // considered, signF = -1 will make the FF term in chi0 positive
  // }
  ...
  void setupOrbitalIndices() {
    ...
    if (conc.rank() == 0) {
      std::cout << "nOrbAtom: ";
      for (size_t site = 0; site < nSitesPerUnitCell; site++)
        std::cout << nOrbAtom[site] << " , ";
      std::cout << "\n";
      std::cout << "orbToSite: ";
      for (size_t l = 0; l < nOrb; l++)
        std::cout << l << "->" << orbToSite[l] << " ";
      std::cout << "\n";
    }
    if (conc.rank() == 0)
