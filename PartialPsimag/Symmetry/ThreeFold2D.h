...
#ifndef PSIMAG_ThreeFoldSymmetryElement2D_H
#define PSIMAG_ThreeFoldSymmetryElement2D_H
...
namespace psimag {
  ...
  /**\ingroup symmetryConcepts
   *
   * \brief A class for implementing two-dimensional ThreeFold Symmetry Elements.
   *
   */

  template<typename Field, typename Algorithms>
  class ThreeFold<Field,2,Algorithms>: 
  ...
  public:
     ...
     *        cell translation.
     */
    ThreeFold(const CellTranslationType&    offset):
      SymmetryElementType("threeFold", 
			  latticeCoordinate(0,0),    // => the c-axis direction
			  offset, 
			  convert<Field>("0"))
    ...
    ThreeFold(IN_TYPE p1, IN_TYPE p2):
      SymmetryElementType("threeFold", 
			  latticeCoordinate(0,0),    // => the c-axis direction
